...
class Program
{
    static void Main()
    {
        ...
        library.AddBook("Cien Años de Soledad", "Gabriel García Márquez", "1111111111", 1967);
        library.AddBook("1984", "George Orwell", "2222222222", 1949);
        library.AddBook("Don Quijote de la Mancha", "Miguel de Cervantes", "3333333333", 1605);
        library.AddBook("El Principito", "Antoine de Saint-Exupéry", "4444444444", 1943);
        library.AddBook("Crónica de una Muerte Anunciada", "Gabriel García Márquez", "5555555555", 1981);
